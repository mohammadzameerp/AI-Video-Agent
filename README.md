...
For instructions on deploying the application to the web using **Streamlit Community Cloud** (free hosting) or other hosting platforms, refer to the **[DEPLOYMENT.md](DEPLOYMENT.md)** guide.
